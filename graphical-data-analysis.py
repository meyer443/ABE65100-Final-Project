...
def generate_scatter_plot( dataFrame, outFileName ):
    plt.scatter(dataFrame['Q'], dataFrame['Dissolved Oxygen (mg/L)'], marker=".") # plot points of depth vs magnitude, "." marker to manipulate point size
...
def generate_new_scatter_plot( dataFrame, outFileName ):
    plt.scatter(dataFrame['Depth'], dataFrame['Dissolved Oxygen (mg/L)'], marker=".") # plot points of depth vs magnitude, "." marker to manipulate point size
